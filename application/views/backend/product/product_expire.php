<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        <b>ข้อมูลผลิตภัณฑ์ที่หมดอายุฮาลาล</b>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
        <li class="active">ข้อมูลผลิตภัณฑ์ที่หมดอายุฮาลาลทั้งหมด</li>
      </ol>
    </section>
          ...
          <div class="col-xs-12">
            <div class="box">
              <div class="box-header">
                <h3 class="box-title"><b>ข้อมูลผลิตภัณฑ์ที่หมดอายุฮาลาล</b></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                    ...
                    <div class="box-tools pull-right">
                      <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                        <div class="btn-group" role="group" aria-label="1 group">
                          ...
                          <!-- <a href ="<?php echo site_url('/Backend_control/insert_product') ?>" class="btn btn-sm btn-success btn-flat act-trash"  title="เพิ่มผลิตภัณฑ์">
                            <i class="fa fa-bars"></i> เพิ่มผลิตภัณฑ์
                          </a> -->
                        </div>
                        <div class="btn-group" role="group" aria-label="2 group">
                          ...
                          <a href ="<?php echo site_url('/Backend_control/product') ?>" class="btn btn-sm btn-default btn-flat act-trash"  title="รายการผผลิตภัณฑ์">
                            <i class="fa fa-bars"></i> รายการผผลิตภัณฑ์
                          </a>
                        </div>
                      </div>
                      ...
                      if ($p_status != '1') {
                        ...
                        if ($date_time > $h_expire) { ?>
                          <tr class="css_tr_data">
                            ...
                            <td>
                              <a id="<?php echo $rw->p_id; ?>" class="pro_detail btn btn-sm btn-flat btn-success trash-multi" title="รายละเอียด" data-toggle="modal" data-target="#pro_detail">
                                <i class="fa fa-eye"></i> รายละเอียด</a> 
                            </td>

                            <td>
                              <a id="" href ="<?php echo site_url("Backend_control/product_edit/".$rw->p_id); ?>" class="btn btn-sm btn-flat btn-success trash-multi" title="แก้ไข" >
                    ...
                    let html = "";
                        $.each($result, function(i, v){
                          html += '<div class="content1"> '
                                    ...
                                    + '</p> '
                                    + '<p>'
                                      + '<b>รหัสผลิตภัณฑ์ : '+v["p_idproduct"]
                                    + '</p> '
                                    + '<p>'
                                      + '<b>ชื่อผลิตภัณฑ์ : '+v["p_name"]
                                    + '</p> '
                                    + '<p>'
                                      + '<b>รสชาติ : '+v["p_taste"]
                                    + '</p> '
                                    + '<p>'
                                      + '<b>ขนาดผลิตภัณฑ์ : '+v["p_size"]
                                    + '</p> '
                                    + '<p>'
                                      + '<b>เลขบาร์โค้ด : '+v["p_barcode"]
                                    + '</p> '
                                    // + '<p>'
                    ...
                    let html = "";
                        $.each($result, function(i, v){
                          html += '<tr class="css_tr_data" id="'+ v["p_id"] +'">'
                            ...
                            + '<td>'
                              + '<a id="'+ v["p_id"] +'" class="pro_detail btn btn-sm btn-flat btn-success trash-multi" title="รายละเอียด" data-toggle="modal" data-target="#pro_detail">'
                                + '<i class="fa fa-eye"></i> รายละเอียด</a> '
                            + '</td>'
                            + '<td>'
