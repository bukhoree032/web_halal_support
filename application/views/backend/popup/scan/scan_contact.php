...
<style type="text/css">
  ...
  <div class="modal fade" id="myModal_scan_contact" role="dialog">
      ...
      <div class="modal-content"> 
        ...
        <div class="modal-body" style="padding-bottom: 5px;">
          <div class="text-center" style="padding-bottom: 10px;">
             <strong class="st1">
            <?php
              echo "ไม่พบข้อมูลผลิตภัณฑ์หรือหมายเลขบาร์โค้ดที่ค้นหา";
            ?>
            </strong>
            <br>
            <!-- <div class="black">
            ...
            <?php
                echo "โปรดติดต่อเพื่อแนะนำชื่อผลิตภัณฑ์ที่ยังไม่มีในระบบ";
              ?>
                <br>
          </div>
          <div class="modal-footer bs">
            <form id="form_scan" class=""  name="form_scan"  method="post" enctype="multipart/form-data">
            <div class="content1"> 
                ...
                <!-- ปุ่มกดปิด (Close) ตรงส่วนล่างของ Modal -->
                  <div class="text-center"> 
                    <div class="row"></div>
                    <a href="<?php echo site_url('/Frontend_control/contact') ?>" class="btn btn-prymary" style="background-color: #43AF52">แจ้งตรวจสอบผลิตภัณฑ์</a>
