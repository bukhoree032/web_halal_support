  ...
  <div class="modal fade" id="myModal_replect" role="dialog">
      ...
      <div class="modal-content">
        ...
        <!-- <form id="form_contact1" action="<?php echo site_url('Frontend_control/contact') ?>" name="form" method="post"> -->
          ...
          <div class="modal-body">
            <center>
              <?php  
                  echo "ไม่พบส่วนผสมที่สามารถทดแทนได้";
              ?>

            </center>
            <br>
            <div class="modal-footer"> 
              <input type="button" value="ปิด" data-dismiss="modal" class="btn btn-primary" style="background-color: red">
