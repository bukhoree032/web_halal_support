			...
			<div class="gtco-container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
						<h1 class="cursive-font primary-color">Products and Ingredients</h1>
		            ...
		            <div class="row tree">
		            	<center>
			                <div class="col-lg-4 col-md-4 col-sm-6">
			                    <div class="service-item">
			                        <a href="<?php echo site_url('/frontend_control/ingredient_halal/'."1") ?>" class="fh5co-card-item">
			                ...
			                <div class="col-lg-4 col-md-4 col-sm-6">
			                    <div class="service-item">
			                        <a href="<?php echo site_url('/frontend_control/ingredient_halal/'."2") ?>" class="fh5co-card-item">
			                ...
			                <div class="col-lg-4 col-md-4 col-sm-6">
			                    <div class="service-item">
			                        <a href="<?php echo site_url('/frontend_control/ingredient_halal/'."3") ?>" class="fh5co-card-item" >
			                        <img src="<?php echo base_url('/api_front1/') ?>images/syubhat2.png" class="img-responsive">
						...
						<div class="col-lg-4 col-md-4 col-sm-6" >
							<a href="<?php echo site_url('Frontend_control/show_i/'.$rw->i_id) ?>" class="fh5co-card-item">
								...
								<div class="fh5co-text">
									...
									<p><!--<b>Name :</b> <?php echo $rw->i_name;?><br>--> 
