													...
													<form id="form_rigister" method="post" action="<?php echo site_url("frontend_control") ?>">
														...
														<div class="row form-group">
															...
															<div class="col-md-4">
																...
																<input type="password" id="password" name="password" class="th form-control" 
																onblur="onblur_password()">
															</div>
															<div class="col-md-4">
																<label for="text-start">ยืนยันรหัสผ่าน <font color="red">*</font></label>
																<input type="password" id="password_confrim" name="password_confrim" class="th form-control"
														...
														<font color="white">มีบันชีผู้ใช้แล้ว</font> <a href="<?php echo site_url("frontend_control/login") ?>">เข้าสู่ระบบ</a> 
													</form>	
												</div>
