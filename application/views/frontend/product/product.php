		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading">
					<h2 class="cursive-font primary-color">Products and Ingredients</h2>
				...
				<div class="tab-content-inner active" data-content="signup">
					...
					<form id="form_search_pro" method="post">
						<div class="row form-group row1">
							<div class="col-md-8">
								<input type="text" id="" placeholder="Search" name="search_p" class="form-control">
							</div>
							<div class="col-md-4">
								<button type="submit" class="btn search1">Search</button>
							</div>
						</div>												
					</form>	
				</div>	
					...
					<div class="col-lg-4 col-md-4 col-sm-6" >
						<a href="<?php echo site_url('Frontend_control/show_p/'.$rw->p_id) ?>" class="fh5co-card-item">
							...
							<div class="fh5co-text">
								...
								<p><b>Name :</b> <?php echo $rw->p_name_eng;?><br>
